...
public class ReceipRegPage {

	
	public JFrame frmRecepPage;
	...
	private void initialize() {
		frmRecepPage = new JFrame();
		frmRecepPage.setTitle("Receptionist Reg Page");
		frmRecepPage.setResizable(false);
		frmRecepPage.getContentPane().setFont(new Font("Verdana", Font.PLAIN, 14));
		frmRecepPage.setBounds(100, 100, 720, 526);
		frmRecepPage.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frmRecepPage.getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBorder(new LineBorder(new Color(0, 0, 0)));
		panel.setBounds(146, 0, 568, 497);
		frmRecepPage.getContentPane().add(panel);
		...
		lblAddress.setBounds(95, 263, 90, 14);
		...
		RecepAddress.setBounds(249, 245, 172, 46);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if((!new String(password.getPassword()).equals(""))&&(!UserName.getText().equals(""))&&(!RecepAddress.getText().equals(""))&&(!PhoneNo.getText().equals(""))&&(!Age.getText().equals(""))&&(!FirstName.getText().equals(""))&&(!LastName.getText().equals("")))
				  flag1=1;
				else
				{
				...
				if(flag==1&&flag1==1&&flag2==1&&flag3==1)
				{
					...
					frmRecepPage.dispose();
					ReceipPostLogin window =new ReceipPostLogin(map.get(lblUsername.getText()),map.get("Id"));
		...
		frmRecepPage.getContentPane().add(panel_1);
